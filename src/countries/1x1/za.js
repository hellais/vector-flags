...
const FlagZA = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={512} width={512} id="flag-icon-css-za" viewBox="0 0 512 512" {...props}>
      <defs>
        <clipPath id="a">
          <path fillOpacity=".67" d="M70.133 0h499.61v499.61H70.133z" />
        </clipPath>
      </defs>
      <g transform="translate(-71.873) scale(1.0248)" clipPath="url(#a)">
