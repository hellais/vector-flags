...
const FlagMY = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={512} height={512} id="flag-icon-css-my" viewBox="0 0 512 512" {...props}>
      <path d="M0 .05h512v512H0z" fill="#cc0001" />
      <path d="M0 475.48h512v36.57H0z" fill="#fff" id="a" />
      <use xlinkHref="#a" transform="translate(0 -73.143)" width="100%" height="100%" />
      <use xlinkHref="#a" transform="translate(0 -146.286)" width="100%" height="100%" />
      <use xlinkHref="#a" transform="translate(0 -219.43)" width="100%" height="100%" />
      <use xlinkHref="#a" transform="translate(0 -292.57)" width="100%" height="100%" />
      <use xlinkHref="#a" transform="translate(0 -365.714)" width="100%" height="100%" />
      <use xlinkHref="#a" transform="translate(0 -438.857)" width="100%" height="100%" />
