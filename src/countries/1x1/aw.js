...
const FlagAW = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={512} width={512} id="flag-icon-css-aw" viewBox="0 0 512 512" {...props}>
      <defs>
        <clipPath id="a">
      ...
      <g clipPath="url(#a)">
        ...
        <path d="M121.673 32.904L104.986 96.16l-63.442 17.23 63.26 16.51 16.87 63.257L138.54 129.9l63.26-16.87-63.26-16.87-16.867-63.256z" stroke="#fff" strokeWidth="2.975" fill="#c00" />
