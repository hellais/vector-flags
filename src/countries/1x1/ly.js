...
const FlagLY = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={512} width={512} id="flag-icon-css-ly" viewBox="0 0 512 512" {...props}>
      <defs>
        <clipPath id="a">
          <path d="M250 12h500v500H250z" />
        </clipPath>
      </defs>
      <g clipPath="url(#a)" transform="translate(-256 -12.288) scale(1.024)">
