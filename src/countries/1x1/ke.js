...
const FlagKE = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height={512} width={512} id="flag-icon-css-ke" viewBox="0 0 512 512" {...props}>
      <defs>
        <path strokeMiterlimit={10} d="M-28.58 47.5l1.733 1 46.713-80.91c2.732-.73 4.232-3.33 5.732-5.927 1-1.732 5-8.66 6.734-17.663-6.93 6.003-10.93 12.93-11.93 14.663-1.5 2.598-3 5.196-2.268 7.928z" id="a" />
      </defs>
      ...
      <use height="100%" width="100%" xlinkHref="#b" transform="matrix(-1 0 0 1 511.708 0)" />
      ...
      <use height="100%" width="100%" xlinkHref="#c" transform="matrix(-1 0 0 1 511.708 0)" />
