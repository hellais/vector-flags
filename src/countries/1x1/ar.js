...
const FlagAR = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height={512} width={512} id="flag-icon-css-ar" viewBox="0 0 512 512" {...props}>
      <path fill="#74acdf" d="M0 0h512v512H0z" />
      <path fill="#fff" d="M0 170.67h512v170.67H0z" />
      <g id="c" transform="translate(-153.6) scale(1.024)">
        <path id="a" d="M396.84 251.31l28.454 61.992s.49 1.185 1.28.859c.79-.327.299-1.512.299-1.512l-23.715-63.956m-.68 24.12c-.347 9.428 5.452 14.613 4.694 23.032-.757 8.42 3.867 13.18 4.94 16.454 1.073 3.274-1.16 5.232-.198 5.698.963.466 3.07-2.12 2.383-6.775-.687-4.655-4.22-6.037-3.39-16.32.83-10.283-4.206-12.678-2.98-22.058" fill="#f6b40e" stroke="#85340a" strokeWidth="1.112" />
        <use height="100%" width="100%" xlinkHref="#a" transform="rotate(22.5 400 250)" />
        <use height="100%" width="100%" xlinkHref="#a" transform="rotate(45 400 250)" />
        <use height="100%" width="100%" xlinkHref="#a" transform="rotate(67.5 400 250)" />
        ...
        <use height="100%" width="100%" xlinkHref="#b" transform="rotate(22.5 400 250)" />
        <use height="100%" width="100%" xlinkHref="#b" transform="rotate(45 400 250)" />
        <use height="100%" width="100%" xlinkHref="#b" transform="rotate(67.5 400 250)" />
      </g>
      <use height="100%" width="100%" xlinkHref="#c" transform="rotate(90 256 256)" />
      <use height="100%" width="100%" xlinkHref="#c" transform="rotate(180 256 256)" />
      <use height="100%" width="100%" xlinkHref="#c" transform="rotate(-90 256 256)" />
      <circle r="28.445" cy={256} cx={256} fill="#f6b40e" stroke="#85340a" strokeWidth="1.536" />
      ...
      <use height="100%" width="100%" xlinkHref="#d" transform="matrix(-1 0 0 1 512.256 0)" />
      <use height="100%" width="100%" xlinkHref="#e" transform="matrix(-1 0 0 1 512.256 0)" />
      <use height="100%" width="100%" xlinkHref="#f" transform="translate(19.315)" />
      <use height="100%" width="100%" xlinkHref="#g" transform="matrix(-1 0 0 1 512.256 0)" />
      ...
      <use height="100%" width="100%" xlinkHref="#h" transform="translate(-19.641)" />
