...
const FlagNP = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={512} width={512} id="flag-icon-css-np" viewBox="0 0 512 512" {...props}>
      <defs>
        <clipPath id="b">
      ...
      <g clipPath="url(#a)">
        ...
        <g transform="translate(0 15.957)" clipPath="url(#b)">
          <g fillRule="evenodd">
            <path d="M6.54 489.54l378.786-.01-247.927-251.42 257.263.302L6.561-9.474 6.54 489.54z" stroke="#000063" strokeWidth="12.968" fill="#ce0000" />
