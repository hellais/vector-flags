...
const FlagKP = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={512} width={512} id="flag-icon-css-kp" viewBox="0 0 512 512" {...props}>
      <defs>
        <clipPath id="a">
          <path fillOpacity=".67" d="M92.213 7.828h593.6v485.5h-593.6z" />
        </clipPath>
      </defs>
      <g fillRule="evenodd" clipPath="url(#a)" transform="matrix(.86254 0 0 1.0546 -79.537 -8.255)">
        <path stroke="#000" strokeWidth="1.063" fill="#fff" d="M991.81 492.88H4.18V8.38h987.63z" />
