...
const FlagMN = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={512} width={512} id="flag-icon-css-mn" viewBox="0 0 512 512" {...props}>
      ...
      <circle cx="85.627" cy="309.418" r="26.978" fill="#f9cf02" stroke="#c4272f" strokeWidth="3.054" />
      <path d="M85.627 282.44a13.489 13.489 0 0 1 0 26.978 13.489 13.489 0 1 0 0 26.978" fill="none" stroke="#c4272f" strokeWidth="3.054" />
