...
const FlagBI = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={512} width={512} id="flag-icon-css-bi" viewBox="0 0 512 512" {...props}>
      <defs>
        <clipPath id="a">
          <path fill="gray" d="M60.84 337h175v175h-175z" />
        </clipPath>
      </defs>
      <g clipPath="url(#a)" fillRule="evenodd" transform="translate(-178 -985.97) scale(2.9257)">
