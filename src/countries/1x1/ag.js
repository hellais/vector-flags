...
const FlagAG = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={512} width={512} id="flag-icon-css-ag" viewBox="0 0 512 512" {...props}>
      <defs>
        <clipPath id="a">
          <path fill="#25ff01" d="M108.95 47.6h464.86v464.86H108.95z" />
        </clipPath>
      </defs>
      <g clipPath="url(#a)" fillRule="evenodd" transform="translate(-120 -52.427) scale(1.1014)">
