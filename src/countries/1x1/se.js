...
const FlagSE = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={512} width={512} id="flag-icon-css-se" viewBox="0 0 512 512" {...props}>
      <defs>
        <clipPath id="a">
          <path fillOpacity=".67" d="M118.97 7.306H609.7v490.73H118.97z" />
        </clipPath>
      </defs>
      <g clipPath="url(#a)" transform="translate(-124.12 -7.622) scale(1.0433)">
