...
const FlagMK = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={512} width={512} id="flag-icon-css-mk" viewBox="0 0 512 512" {...props}>
      ...
      <circle r="82.286" cy={256} cx={256} fill="#ffe600" stroke="#d20000" strokeWidth="18.286" />
    </svg>
