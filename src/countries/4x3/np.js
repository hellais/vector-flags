...
const FlagNP = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={480} width={640} id="flag-icon-css-np" viewBox="0 0 640 480" {...props}>
      <defs>
        <clipPath id="a">
          <path fillOpacity=".67" d="M0-15.957h512v512H0z" />
        </clipPath>
      </defs>
      <path fill="#fff" d="M0 0h640v480H0z" />
      <g clipPath="url(#a)" transform="translate(0 14.96) scale(.9375)">
        <g fillRule="evenodd">
          <path d="M6.54 489.54l378.786-.01-247.927-251.42 257.263.302L6.561-9.474 6.54 489.54z" stroke="#000063" strokeWidth="13.833" fill="#ce0000" />
