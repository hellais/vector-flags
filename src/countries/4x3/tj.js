...
const FlagTJ = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height={480} width={640} id="flag-icon-css-tj" viewBox="0 0 640 480" {...props}>
      ...
      <g id="d" transform="translate(320 260.571) scale(.68571)" fill="#f8c300">
