...
const FlagNU = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={480} width={640} id="flag-icon-css-nu" viewBox="0 0 640 480" {...props}>
      <defs>
        <clipPath id="a">
          <path fillOpacity=".67" d="M0 0h496.06v372.05H0z" />
        </clipPath>
      </defs>
      <g transform="scale(1.2902)" clipPath="url(#a)">
