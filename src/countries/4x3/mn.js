...
const FlagMN = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={480} width={640} id="flag-icon-css-mn" viewBox="0 0 640 480" {...props}>
      ...
      <circle cx={107} cy="306.783" r="33.727" fill="#f9cf02" stroke="#c4272f" strokeWidth="3.818" />
      <path d="M107 273.056a16.864 16.864 0 0 1 0 33.727 16.864 16.864 0 1 0 0 33.727" fill="none" stroke="#c4272f" strokeWidth="3.818" />
