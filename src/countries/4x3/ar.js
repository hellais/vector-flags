...
const FlagAR = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height={480} width={640} id="flag-icon-css-ar" viewBox="0 0 640 480" {...props}>
      ...
      <use height="100%" width="100%" xlinkHref="#c" transform="rotate(-90 320 240)" />
      <circle r="26.667" cy={240} cx={320} fill="#f6b40e" stroke="#85340a" strokeWidth="1.44" />
      ...
      <use height="100%" width="100%" xlinkHref="#d" transform="matrix(-1 0 0 1 640.24 0)" />
      <use height="100%" width="100%" xlinkHref="#e" transform="matrix(-1 0 0 1 640.24 0)" />
      <use height="100%" width="100%" xlinkHref="#f" transform="translate(18.108)" />
      <use height="100%" width="100%" xlinkHref="#g" transform="matrix(-1 0 0 1 640.24 0)" />
      ...
      <use height="100%" width="100%" xlinkHref="#h" transform="translate(-18.414)" />
