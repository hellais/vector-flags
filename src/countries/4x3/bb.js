...
const FlagBB = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height={480} width={640} id="flag-icon-css-bb" viewBox="0 0 640 480" {...props}>
      ...
      <use height="100%" width="100%" xlinkHref="#a" transform="matrix(-1 0 0 1 639.54 0)" />
    </svg>
