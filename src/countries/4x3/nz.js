...
const FlagNZ = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height={480} width={640} id="flag-icon-css-nz" viewBox="0 0 640 480" {...props}>
      <defs>
        <g id="b">
          <g id="a">
      ...
      <path clipPath="url(#c)" d="M0 0l600 300M0 300L600 0" transform="matrix(.60681 0 0 .73139 .004 0)" stroke="#fff" strokeWidth={60} />
      <path clipPath="url(#d)" d="M0 0l600 300M0 300L600 0" transform="matrix(.60681 0 0 .73139 .004 0)" stroke="#cc142b" strokeWidth={40} />
      <path style={{lineHeight: 'normal', textIndent: 0, textAlign: 'start', textDecorationLine: 'none', textDecorationStyle: 'solid', textDecorationColor: '#000', textTransform: 'none', blockProgression: 'tb', isolation: 'auto', mixBlendMode: 'normal'}} clipPath="url(#c)" d="M151.707-.002v79.37H.004v60.68h151.703v79.37h60.682v-79.37h151.703v-60.68H212.389V-.003z" color="#000" fontWeight={400} fontFamily="sans-serif" white-space="normal" overflow="visible" fill="#fff" />
      <path style={{lineHeight: 'normal', textIndent: 0, textAlign: 'start', textDecorationLine: 'none', textDecorationStyle: 'solid', textDecorationColor: '#000', textTransform: 'none', blockProgression: 'tb', isolation: 'auto', mixBlendMode: 'normal'}} d="M163.844.002v91.502H.004v36.408h163.84v91.502h36.408v-91.502h163.84V91.504h-163.84V.002z" color="#000" fontWeight={400} fontFamily="sans-serif" white-space="normal" overflow="visible" fill="#cc142b" />
    </svg>
