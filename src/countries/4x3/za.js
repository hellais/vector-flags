...
const FlagZA = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={480} width={640} id="flag-icon-css-za" viewBox="0 0 640 480" {...props}>
      <defs>
        <clipPath id="a">
          <path fillOpacity=".67" d="M-71.873-.012h682.68v512.01h-682.68z" />
        </clipPath>
      </defs>
      <g clipPath="url(#a)" transform="translate(67.379 .011) scale(.93748)">
